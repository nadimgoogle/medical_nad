...
public class Krankheit extends Document implements Serializable, Cloneable{
    ...
    private Umls umls;
    private String umlsInfo;
    private List<Umls> listU;

    public List<Umls> getListU() {
        return listU;
    }

    public void setListU(List<Umls> listU) {
        this.listU = listU;
    }

    public String getUmlsInfo() {
        return umlsInfo;
    }

    public void setUmlsInfo(String umlsInfo) {
        this.umlsInfo = umlsInfo;
    }
